...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Dodaj Grafik Pracownika')); ?>
...
<?php endif; ?>
                    ...
                    <form method="POST" action="<?php echo e(route('grafik.store')); ?>">
                        <?php echo csrf_field(); ?>

                        <label for="data" class="block font-medium text-sm text-gray-700">Data:</label>
                        <input type="date" id="data" name="data" value="<?php echo e($data); ?>" class="border rounded p-2 w-full mb-4">
                        ...
                        <select id="PracownikID" name="PracownikID" class="border rounded p-2 w-full mb-4">
                            <?php $__currentLoopData = $pracownicy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pracownik): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($pracownik->PracownikID); ?>">
                        ...
                        <div class="flex justify-between">
                            ...
                            <a href="<?php echo e(route('grafik.index', ['data' => $data])); ?>" class="bg-red-500 text-white px-4 py-2 rounded">Anuluj</a>
                        </div>
                    </form>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\dashboard\kino\resources\views/grafik/create.blade.php ENDPATH**/ ?>