            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mt-8">
                        ...
                        <form method="GET" action="<?php echo e(route('sprzedawca.index')); ?>" id="dataForm" class="mb-6">
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\dashboard\kino\resources\views/sprzedawca/index.blade.php ENDPATH**/ ?>